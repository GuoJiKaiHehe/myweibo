...
<head>
    ...
    <link rel="stylesheet" href="/Public/jqueryui/jquery-ui-1.9.2.min.css" />
...
<body>
    <div id='top'>
         logo
        <a href='' class='home'>-微博首页-</a>
    </div>
    <div id='main'>
        <div id="login">
            <p class='user_logo'><b>登录</b></p>
            <div class='login_form'>
                <form action="/index.php/Admin/Login/check" method="post" name="login">
                    <p>
                        <label>用户名：</label>
                    ...
                    <p class='verify'>
                        ...
                        <img width="80" height="25" src="<?php echo U('getVerify');?>" id="getCode"/>
                    </p>
                    <p class='login_btn'>
